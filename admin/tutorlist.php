				...
				<div class="col-lg-12">
					<div class="row align-items-center mb-4">
						<div class="col-md-6 mb-3 mb-md-0">
							<h4 class="mb-0 page-title text-uppercase"><span class="vline"></span>Tutor Management</h4>
						</div>
						<div class="col-md-6">
				...
				<div class="col-md-12 mb-4">
				    <div class="card-block p-4">
				    	...
				    	<div class="row align-items-center flex-column-reverse flex-md-row">
					     ...
					     <?php
				    	  $sql = "SELECT * FROM tbl_regusers where utype = '3'";
						  ...
						  ?>
							...
							while($row = mysqli_fetch_assoc($result)){
								...
								$email = $row['email'];
								$phone = $row['phone'];
								$wportelegramno = $row['wportelegramno'];
								$gender = $row['gender'];
								$status = $row['status'];
								if($gender == '1'){
									$genderval = 'Man';
			                ...
			                <td><?php echo $wportelegramno; ?></td>
			                <td><?php echo $genderval; ?></td>
			                <!-- <td class="text-warning">In Process </td> -->
			                <td class="<?php echo $status_cls; ?>"><?php echo $status_val; ?></td>
			                <td>
								<label class="switch">
									<input type="checkbox" onchange="chnagsstudentstatus(this,<?php echo $id; ?>);" <?php if($status == 'active'){ echo "checked data-currentvalue='1'"; }else { echo "data-currentvalue='0'";} ?>>
