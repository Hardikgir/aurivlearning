<?php session_start();
	...
	$sql = "SELECT tbl_tutor_preference_details. *, tbl_regusers. * FROM tbl_tutor_preference_details INNER JOIN tbl_regusers ON tbl_tutor_preference_details.regid = tbl_regusers.user_id WHERE user_id=" .$user_id;
					...
					<div class="col-xl-9">
						...
						<div class="side-content pt-3 pb-0">
							<div class="wizard theme-shadow bg-white p-4 rounded">
								<form method="post" action="tutorprofileupdate.php">
			        			<div class="row">
		                  ...
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Name</h6>
		                         	<input type="text" class="form-control" name="fname" value= "<?php if(!empty($row ['fname'])) {echo $row['fname'];} ?>"  placeholder="Anne Sullivan">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                  ...
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Phone number</h6>
		                         	<input type="text" class="form-control" name="phone" value="<?php if(!empty($row ['phone'])){echo $row['phone'];} ?>" placeholder="+ 91 78945 78956">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Whatsapp/telegram number </h6>
		                         	<input type="text" class="form-control" name="wportelegramno" value="<?php if(!empty($row['wportelegramno'])){echo $row['wportelegramno']; } ?>" placeholder=" + 91 45785 12545">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                  ...
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Language Known</h6>
		                         	<input type="text" class="form-control" name="lang_known" value="<?php if(!empty($row['language_known'])) { echo $row['language_known']; } ?>" placeholder="English">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Identification type</h6>
		                         	<input type="text" class="form-control" name="identification" value="<?php if(!empty($row['identification_type'])) { echo $row['identification_type']; } ?>" placeholder="8900 0089 0000 89000">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Identification Number</h6>
		                         	<input type="text" class="form-control" name="inden_num" value="<?php if(!empty($row['identification_number'])) { echo $row['identification_number']; } ?>" placeholder="8900 0089 0000 89000">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Highest qualification</h6>
		                         	<input type="text" class="form-control" name="high_qulifi" value="<?php if(!empty($row['high_qulifi'])) { echo $row['high_qulifi']; } ?>" placeholder="Masters In Teaching">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Teaching Experience</h6>
		                         	<input type="text" class="form-control" name="teach_exp" value="<?php if(!empty($row['teaching_experience'])) { echo $row['teaching_experience']; } ?>" placeholder="5 years">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Subject Preference</h6>
		                         	<input type="text" class="form-control" name="sub_pref" value="<?php if(!empty($row['subject_preference'])) { echo $row['subject_preference']; } ?>" placeholder="Subject Preference">
		                      </div>
		                  </div>
		                  <div class="col-md-6 mb-2">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Extra curricular Activity Preference</h6>
		                         	<input type="text" class="form-control" name="activ_pref" value="<?php  if(!empty($row['extra_curricular_activity_preference'])) {  echo $row['extra_curricular_activity_preference']; } ?>" placeholder="Research">
		                      </div>
		                  </div>
		                  <div class="col-md-12 mb-3">
		                      <div class="form-group">
		                      	<h6 class="font-weight-bold mb-2">Bio</h6>
		                         	<textarea class="form-control" rows="5" name="bio" placeholder="Add Your Bio"><?php if(!empty($row['bio'])){ echo $row['bio'];  } ?></textarea>
		                      </div>
		                  </div>
