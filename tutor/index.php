				                            		...
				                            		<div class="field-box bg-white pt-5 pb-5 mb-5">
														<?php 
															if(isset($_SESSION['usermsg'])){
																if($_SESSION['usermsg'] == '1'){
																	echo '<div class="alert alert-success" id="UserAcknowledgementMSG" role="alert">Registration Successful..</div>';
						                                ...
						                                <div class="row m-lg-5">						                                	
															...
															<div class="col-md-12 text-left">
						                                    	<a href="<?php echo $baseUrl."/tutor/register.php" ?>" class="login-btn border-0 font-weight-bold mx-auto">Register</a>
						                                    </div>
